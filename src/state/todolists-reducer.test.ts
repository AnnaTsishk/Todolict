import {v1} from "uuid";
import {
    addTodolistAC, changeTodolistFilterAC, TodolistsActionsType, changeTodolistTitleAC,
    FilterValuesType,
...
test('correct filter of todolist should be change', () => {
    ...
    // const action: TodolistsActionsType = changeTodolistFilterAC(newFilter,todolistId2)
